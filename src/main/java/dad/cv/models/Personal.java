...
public class Personal {
    ...
    public final ObjectProperty<LocalDate> fechaNacProperty() {
        return this.fechaNac;
    }
    
    public final LocalDate getfechaNac() {
        return this.fechaNacProperty().getValue();
    }
    
    public final void setfechaNac(final LocalDate fechaNac) {
        this.fechaNacProperty().set(fechaNac);
    }
